...
//     const [dataDatePay, setDataDatePay] = useState('');
//     const [dataPassword, setDataPassword] = useState('');
//     const [Membership, setMembership] = useState<{id:string; name_membership:string; membership_duration:string}[]>([]);

//     useEffect(() => {
//         fetch('http://localhost:8000/membership/') // ajusta la URL según tu backend
//         .then(res => res.json())
//         .then(data => setMembership(data))
//         .catch(err => console.error('Error cargando Membresias', err));
//     }, []);
